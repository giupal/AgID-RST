...
|                                   |         |            |         |         | Party           | informazioni che consentono di                 |
|                                   |         |            |         |         |                 | individuare                                    |
|                                   |         |            |         |         |                 | univocamente l’ambito di,                      |
|                                   |         |            |         |         |                 | applicazione della                             |
|                                   |         |            |         |         |                 | richiesta.                                     |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| identificativoDominio             | 2       | an         | 1..1    | 1..35   | Tax             | Campo alfanumerico contenente il               |
|                                   |         |            |         |         | Identification  | codice fiscale della struttura che invia       |
|                                   |         |            |         |         | Number          | la richiesta di pagamento.                     |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| identificativoStazioneRichiedente | 2       | an         |         | 1..35   | Name            | Identifica la stazione richiedente il          |
|                                   |         |            |         |         |                 | pagamento secondo una codifica                 |
|                                   |         |            |         |         |                 | predefinita dal mittente che ne deve           |
|                                   |         |            |         |         |                 | dare evidenza a richiesta.                     |
|                                   |         |            |         |         |                 | Il Nodo dei Pagamenti-SPC non                  |
|                                   |         |            |         |         |                 | effettuaverifiche di congruenza                |
|                                   |         |            |         |         |                 | su tale dato.                                  |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| identificativoMessaggioRichiesta  | 1       | an         |         | 1..35   | Message         | Identificativo legato alla                     |
|                                   |         |            |         |         | Identification  | trasmissione della                             |
...
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| dataOraMessaggioRichiesta         | 1       | an         |         | 19      | Creation        | Indica la data e l’ora digenerazione           |
|                                   |         |            |         |         | Date            | del messaggio di richiesta di                  |
|                                   |         |            |         |         | Time            | pagamento secondo il formato ISO 8601          |
|                                   |         |            |         |         |                 | [YYYY]-[MM]-[DD]T[hh]:[mm]:[ss]                |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| autenticazioneSoggetto            | 1       | an         |         | 4       | Proprietary     | Contiene la modalità di identificazione        |
|                                   |         |            |         |         | Code            | applicata al soggetto che deve essere          |
...
|                                   |         |            |         |         |                 | Pagatore.                                      |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| identificativoUnivocoVersante     | 2       | s          |         |         |                 | Aggregazione che riporta le                    |
|                                   |         |            |         |         |                 | informazioni                                   |
|                                   |         |            |         |         |                 | concernenti l’identificazione                  |
|                                   |         |            |         |         |                 | fiscale del                                    |
|                                   |         |            |         |         |                 | versante.                                      |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| tipoIdentificativoUnivoco         | 3       | an         |         | 1       | Proprietary     | Campo alfanumerico che indica la               |
|                                   |         |            |         |         | Code            | natura del versante;                           |
|                                   |         |            |         |         |                 | può assumere i seguenti valori:                |
|                                   |         |            |         |         |                 |                                                |
|                                   |         |            |         |         |                 | - **F**= Persona fisica                        |
|                                   |         |            |         |         |                 | - **G**= Persona Giuridica.                    |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| codiceIdentificativoUnivoco       | 3       | an         |         | 1..35   | Tax             | Campo alfanumerico che può                     |
|                                   |         |            |         |         | Identification  | contenere il,codice fiscale o,                 |
...
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| tipoIdentificativoUnivoco         | 3       | an         |         | 1       | Proprietary     | Campo alfanumerico che indica                  |
|                                   |         |            |         |         | Code            | la natura del pagatore                         |
...
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| tipoIdentificativoUnivoco         | 3       | an         |         | 1       | Proprietary     | Campo                                          |
|                                   |         |            |         |         | Code            | alfanumerico che indica la natura              |
|                                   |         |            |         |         |                 | dell’ente beneficiario; se presente            |
|                                   |         |            |         |         |                 | deve assumere il valore **G**                  |
|                                   |         |            |         |         |                 | Identificativo fiscale Persona Giuridica.      |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| codiceIdentificativoUnivoco       | 3       | an         |         | 1..35   | Tax             | Campo                                          |
|                                   |         |            |         |         | Identification  | alfanumerico contenente il codice              |
|                                   |         |            |         |         | Number          | fiscale dell’Ente Creditore destinatario       |
|                                   |         |            |         |         |                 | del pagamento.                                 |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
...
|                                   |         |            |         |         |                 | operativa destinataria                         |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| civicoBeneficiario                | 2       | an         |         | 1..16   | Building        | Indica il numero civico dell’ente              |
|                                   |         |            |         |         | Number          | beneficiario.                                  |
|                                   |         |            |         |         |                 | Può coincidere con quello dell’unità           |
|                                   |         |            |         |         |                 | operativa destinataria.                        |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
...
|                                   |         |            |         |         |                 | operativa destinataria                         |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| provinciaBeneficiario             | 2       | an         |         | 1..35   | Country         | Indica la provincia dell’ente beneficiario.    |
|                                   |         |            |         |         | SubDivision     | Può coincidere con quello dell’unità           |
|                                   |         |            |         |         |                 | operativa destinataria                         |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
...
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| dataEsecuzionePagamento           | 2       | an         |         | 10      | Requested       | Indica la data in cui si richiede che          |
|                                   |         |            |         |         | Execution       | venga effettuato                               |
...
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| importoTotaleDaVersare            | 2       | an         |         | 3..12   | Amount          | Campo numerico (due cifre per la               |
|                                   |         |            |         |         |                 | parte decimale,                                |
...
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| identificativoUnivocoVersamento   | 2       | an         |         | 1..35   | Creditor        | Riferimento univoco assegnato al               |
|                                   |         |            |         |         | Reference       | versamento dall’Ente                           |
...
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| CodiceContestoPagamento           | 2       | an         |         | 1..35   | Message         | Codice univoco necessario a definire il        |
|                                   |         |            |         |         | Identification  | contesto                                       |
|                                   |         |            |         |         |                 | nel quale viene effettuato il versamento.      |
|                                   |         |            |         |         |                 | Si faccia riferimento al § 7.3 della           |
|                                   |         |            |         |         |                 | presente Sezione.                              |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| ibanAddebito                      | 2       | an         |         | 1..35   | Debtor.         | Identifica l’International Bank Account        |
|                                   |         |            |         |         | Account         | Number del conto da addebitare,                |
...
|                                   |         |            |         |         | BIC             | Identifier Code della banca di addebito,       |
|                                   |         |            |         |         |                 | definito secondo lo standard ISO 9362.         |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| firmaRicevuta                     | 2       | an         |         | 1..1    | Proprietary     | Codice del tipo di firma digitale o,           |
|                                   |         |            |         |         | Code            | elettronica qualificata cui deve essere        |
...
|                                   |         |            |         |         |                 | compatibilità.                                 |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| datiSingoloVersamento             | 2       | S          |         |         |                 | Aggregazione “dati dei singoli                 |
|                                   |         |            |         |         |                 | versamenti” da un minimo di uno                |
...
|                                   |         |            |         |         |                 | **“0.00”**.                                    |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| ibanAccredito                     | 3       | an         |         | 1..35   | Creditor        | Identifica l’International Bank Account        |
|                                   |         |            |         |         | Account         | Number,                                        |
|                                   |         |            |         |         | IBAN            | definito secondo lo standard ISO 13616,        |
...
|                                   |         |            |         |         | Agent           | Identifier Code definito secondo               |
|                                   |         |            |         |         | BIC             | lo standard                                    |
|                                   |         |            |         |         |                 | ISO 9362 presso la quale deve                  |
|                                   |         |            |         |         |                 | essere effettuato                              |
|                                   |         |            |         |         |                 | l’accredito.                                   |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| ibanAppoggio                      | 3       | an         |         | 1..35   | Creditor        | Identifica l’International Bank Account        |
|                                   |         |            |         |         | Account         | Number,definito secondo lo standard            |
|                                   |         |            |         |         | IBAN            | ISO 13616,                                     |
...
|                                   |         |            |         |         | Information     | del versamento che deve essere                 |
|                                   |         |            |         |         |                 | conforme                                       |
|                                   |         |            |         |         |                 | a quanto indicato nella Sezione I              |
|                                   |         |            |         |         |                 | dell’Allegato A alle Linee guida.              |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| datiSpecificiRiscossione          | 3       | an         |         | 1..140  | Additional      | Rappresenta l’indicazione                      |
|                                   |         |            |         |         | Remittance      | dell’imputazione della specifica               |
...
|                                   |         |            |         |         |                 | - **1** Numero,della contabilità               |
|                                   |         |            |         |         |                 |               speciale                         |
|                                   |         |            |         |         |                 | - **2** Codice,SIOPE                           |
|                                   |         |            |         |         |                 | - **9** Altro codice ad uso dell’Ente          |
|                                   |         |            |         |         |                 |              Creditore                         |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| datiMarcaBolloDigitale            | 3       | s          |         |         |                 | Aggregazione che contiene le                   |
...
|                                   |         |            |         |         |                 | non sia presente.                              |
|                                   |         |            |         |         |                 | In tutti gli altri casi non deve essere        |
|                                   |         |            |         |         |                 | popolata.                                      |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| tipoBollo                         | 4       | an         |         | 2       | Proprietary     | Contiene la tipologia di Bollo Digitale.       |
|                                   |         |            |         |         | Code            | Può assumere i seguenti                        |
|                                   |         |            |         |         |                 | valori:                                        |
|                                   |         |            |         |         |                 |                                                |
|                                   |         |            |         |         |                 |                                                |
|                                   |         |            |         |         |                 | **01 Imposta di bollo**                        |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| hashDocumento                     | 4       | an         |         | 70      |                 | Contiene l’impronta informatica                |
|                                   |         |            |         |         |                 | (digest)                                       |
|                                   |         |            |         |         |                 | del documento informatico cui è                |
|                                   |         |            |         |         |                 | associata la                                   |
|                                   |         |            |         |         |                 | marca da bollo                                 |
|                                   |         |            |         |         |                 | digitale.                                      |
|                                   |         |            |         |         |                 | L’algoritmo di hash                            |
...
|                                   |         |            |         |         |                 | algoritmo deve essere convertito               |
|                                   |         |            |         |         |                 | in base64                                      |
+-----------------------------------+---------+------------+---------+---------+-----------------+------------------------------------------------+
| provinciaResidenza                | 4       | an         |         | 2       | Proprietary     | Sigla automobilistica della                    |
|                                   |         |            |         |         | Code            | provincia di                                   |
